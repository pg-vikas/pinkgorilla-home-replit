  ...
  return (
    <section className="py-32 bg-background relative overflow-hidden" id="platform">
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div ref={containerRef} className="relative w-full max-w-6xl mx-auto flex flex-col md:flex-row items-stretch justify-center gap-8 md:gap-0 mt-10 pb-20 min-h-[800px] md:min-h-[600px]">
